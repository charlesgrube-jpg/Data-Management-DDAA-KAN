...
%  NeurIPS 2026 — Track on Evaluations and Datasets (eandd)
%  Submission: anonymous. Camera-ready: [eandd, final]
% ============================================================
...
% Use [H] (float package): without it, deferred [ht] floats plus \clearpage
% before the checklist can still reorder output so checklist text appears
% between appendix figures.
